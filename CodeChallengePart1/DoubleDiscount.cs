...
namespace CodeChallengePart1
{
    ...
    class DoubleDiscount
    {
        ...
        struct Purchase
        {
            ...
            {
                Console.WriteLine("Customer Name:{0,-10} \nCustomer Purchased amount:{1,-10} \nCustomer CardType:{2,-10} \nCustomer's Payable Amount:{3}", this.CustomerName, this.PurchaseAmount, this.MemberCardType, this.PayableAmount);
                Console.ReadKey();
